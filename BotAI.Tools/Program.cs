...
internal sealed class NavBuildOptions
{
    public const string Usage =
        "usage: dotnet run --project BotAI.Tools -- [--map MapName] [--output Path] [--include-custom] [--audit-reachability] [--audit-shipped] [--repair-shipped] [--audit-capture-routes] [--validate-modern-edges] [--build-score-routes] [--score-route-diagnostics] [--score-route-max-phase-routes N] [--score-route-max-proof-attempts N] [--score-route-context-budget-ms N] [--score-route-map-budget-ms N] [--score-route-no-progress-stop-seconds N] [--run-bot-scenario] [--stock-score-matrix] [--stock-ctf-koth-matrix] [--scenario-kind Score|Route|Arrival|ReturnCap] [--team Red|Blue] [--class Scout|Engineer|Pyro|Soldier|Demoman|Heavy|Sniper|Medic|Spy|Quote]... [--seconds N] [--wall-timeout-ms N] [--fail-fast] [--no-bot-diagnostics] [--probe-orange-lip] [--probe-orange-branch] [--probe-modern-edge --from-node N --to-node N [--start-x X --start-bottom Y]] [--probe-modern-chain --chain-nodes N,N,N [--start-x X --start-bottom Y]] [--probe-collision-window --start-x X --start-bottom Y] [--probe-gml-link --from-node N --to-node N]";
