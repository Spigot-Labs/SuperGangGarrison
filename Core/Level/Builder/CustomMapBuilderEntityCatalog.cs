...
public static class CustomMapBuilderEntityCatalog
{
    ...
    [
        ...
        Define(
            ...
            AllModes,
            "xscale=1;yscale=1;team=any;nodePriority=0;logicKey=",
            50,
            "Player trigger",
        ...
        Define(
            ...
            string.Empty,
            0),
        Define(MapLogicMetadata.CpTriggerEntityType, AllModes, "linkObjective=controlPoint1;requiredOwner=red;nodePriority=0;logicKey=", 12, "CP Trigger", "Outputs true when the linked control point matches the required owner (red, blue, neutral, or not neutral).", string.Empty, 0),
        ...
        Define(
            ...
            AllModes,
            "countdownSeconds=1;logicInput=;triggerOnStart=false;nodePriority=0;logicKey=",
            12,
            "Timer",
