...
public static class CustomMapBuilderEntityCatalog
{
    ...
    [
        ...
        Define(PushBlockMetadata.EntityType, AllModes, PushBlockMetadata.DefaultProperties, 66, "Push block", "Resizable zone that pushes players in the selected direction.", "sprite64", 5),
        Define(CatapultMetadata.EntityType, AllModes, CatapultMetadata.DefaultProperties, 68, "Catapult", "Resizable zone that launches players at an angle.", "sprite64", 6),
